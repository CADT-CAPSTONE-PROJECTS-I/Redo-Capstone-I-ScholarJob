{{-- <x-app-layout>
    <x-slot name="header">
        {{ __('Create User or Account') }}
    </x-slot>

    <div class="flex mb-2 space-x-2">
        <a href="{{ route('users.index') }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded hover:bg-gray-600 shadow-lg flex items-center">
