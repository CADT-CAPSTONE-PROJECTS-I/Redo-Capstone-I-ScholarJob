                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="job_type" name="job_type"
                                ...
                                <option value="on_site" {{ old('job_type', $job->job_type) == 'on_site' ? 'selected' : '' }}>On Site</option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="date" id="deadline" name="deadline" value="{{ old('deadline', $job->deadline ? \Carbon\Carbon::parse($job->deadline)->format('Y-m-d') : '') }}"
                                class="form-input mt-1 block w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 required">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select id="urgent" name="urgent"
                                ...
                                <option value="1" {{ old('urgent', $job->urgent) == '1' ? 'selected' : '' }}>Urgent</option>
                                <option value="0" {{ old('urgent', $job->urgent) == '0' ? 'selected' : '' }}>Not Urgent</option>
                            </select>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" placeholder="Enter Job Description"
                                class="form-input mt-1 block w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 required">{{ old('description', $job->description) }}</textarea>
                        </div>
                        <div class="md:col-span-2">
                            ...
                            <textarea id="responsible" name="responsible" placeholder="Enter Job Responsibilities"
                                class="form-input mt-1 block w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 required">{{ old('responsible', $job->responsible) }}</textarea>
                        </div>
