<x-app-layout>
    ...
    <div class="flex mb-2 space-x-2">
        ...
        <button type="submit" form="clientForm" class="bg-blue-500 text-white font-bold ml-2 py-2 px-4 rounded hover:bg-blue-600 shadow-lg flex items-center">
                ...
                <form id="clientForm" action="{{ route('clients.update', $client->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" placeholder="Enter Name" value="{{ old('name', $client->name) }}"
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" placeholder="Enter Email" value="{{ old('email', $client->email) }}"
                                 class="form-input mt-1 block w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
