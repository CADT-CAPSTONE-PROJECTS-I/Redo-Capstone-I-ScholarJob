                ...
                <form id="roleForm" action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="guard_name" name="guard_name" value="{{ old('guard_name') }}" placeholder="Enter Guard Name"
                                class="form-input mt-1 block w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                                                ...
                                                <div class="form-group my-2">
                                                    <div class="checkbox">
                                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                                            <input type="checkbox" class="custom-control-input permission-checkbox" id="{{ $permission->name }}" name="permissions[]" value="{{ $permission->id }}" data-panel="{{ $panel }}">
