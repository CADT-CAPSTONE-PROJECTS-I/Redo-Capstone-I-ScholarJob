                            ...
                            <div class="relative w-full h-64 bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-50">
                                ...
                                <div id="imagePreview" class="flex items-center justify-center">
                                    @if ($scholarship->image)
                                        <img src="{{ asset($scholarship->image) }}" alt="Current Image" class="mt-2 w-32">
                                    @else
                                        <img id="imageDisplay" src="#" alt="Image Preview" class="hidden w-full h-full object-cover rounded-lg" style="height: 300px; width:100%;">
                                    @endif
                                    <span class="text-gray-400" id="placeholder" @if($scholarship->image) style="display: none;" @endif>
